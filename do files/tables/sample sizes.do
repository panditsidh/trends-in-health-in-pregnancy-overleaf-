...
foreach r of numlist 3/5 {
	...
	estpost sum india eag north central east northeast west south rural urban forward obc dalit adivasi muslim sikh_jain_christian nuclear sasural natal if round==`r'
...
foreach var in india eag north central east northeast west south rural urban forward obc dalit adivasi muslim sikh_jain_christian nuclear sasural natal {
	replace `var' = `var'*100
}
...
foreach r of numlist 3/5 {
	...
	estpost sum india eag north central east northeast west south rural urban forward obc dalit adivasi muslim sikh_jain_christian nuclear sasural natal if round==`r' [aw=wt]
