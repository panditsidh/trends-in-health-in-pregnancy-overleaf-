...
if "`c(username)'" == "sidhpandit" {
	...
	global out_dropbox "/Users/sidhpandit/Dropbox/trends in health in pregnancy/figures and tables/cdf nine months bmi.png"
	global out_github "/Users/sidhpandit/Documents/GitHub/trends-in-health-in-pregnancy-overleaf-/figures/cdf nine months bmi.png"
}
...
twoway 
  ...
  (line cdf bmi if round == 4 & v213==1, sort lpattern(solid)  lcolor(green) legend(label(2 "NFHS-4 (2015-2016)"))) 
  (line cdf bmi if round == 5 & v213==1, sort lpattern(solid)   lcolor(red) legend(label(3 "NFHS-5 (2019-2021)"))),
