...
* MAKE SURE HOUSEHOLD ROSTERS OF ALL THREE SURVEYS MATCH
...
if v150==2 {
	...
	* do any of the relationship vars say parent in law, if so what gender	
	...
	foreach i of numlist 2/41 {
		...
		* son of household head
		if hv101_`j'==3 {
			...
			* if it's not the woman's husband
			if v034!=`j' {
				
				replace bade_bhai = 1 if hv105_`j'>
