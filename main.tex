...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{tables/sample_sizes3.png}
    \caption{: NFHS-3 sample sizes table with confidence intervals}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{tables/sample_sizes4.png}
    \caption{: NFHS-4 sample sizes table with confidence intervals}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{tables/sample_sizes5.png}
    \caption{: NFHS-5 sample sizes table with confidence intervals}
\end{figure}
