...
\begin{figure}[H]
    ...
    \caption{: Bar graph of number of living children + current pregnancy among currently pregnant women in the NFHS 3, 4, \& 5}
\end{figure}
...
\begin{table}[H]
    \centering
    \caption{: Proportion of women who report not being pregnant by months since last period in the NFHS 3, 4, \& 5 (non-sterilized)}
    \label{tab:sumstat}
    \adjustbox{width=\textwidth}{\input{tables/report_notpregnant}}
\end{table}
...
\begin{table}[H]
    ...
    \label{tab:sumstat}
    \begin{adjustbox}{width=\textwidth}
        \input{tables/demographics1_age}
    \end{adjustbox}
\end{table}


\section{Demographics 2: Birth interval (by subgroup)}
...
\begin{table}[H]
    ...
    \label{tab:sumstat}
    \begin{adjustbox}{width=\textwidth}
        \input{tables/demographics3_hasboy}
    \end{adjustbox}
\end{table}
...
\begin{table}[H]
    ...
    \label{tab:sumstat}
    \begin{adjustbox}{width=\textwidth}
        \input{tables/demographics3_bord3_plus}
    \end{adjustbox}
\end{table}
...
\begin{table}[H]
    ...
    \label{tab:sumstat}
    \begin{adjustbox}{width=\textwidth}
        \input{tables/demographics3_bord4_plus}
    \end{adjustbox}
\end{table}
...
\section{Sum stats response rates}
...
\begin{table}[H]
    ...
    \label{tab:sumstat}
    \begin{adjustbox}{width=\textwidth}
        \input{tables/hh_structure_subgroups_ci}
    \end{adjustbox}
\end{table}
...
\begin{table}[H]
    ...
    \label{tab:sumstat}
    \begin{adjustbox}{width=\textwidth}
        \input{tables/underweight_age_reweight}
    \end{adjustbox}
\end{table}
...
\section{Prepregnancy underweight by parity and social group}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/maternal nutrition by social group/underweight_fwd_vs_group2.png}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/maternal nutrition by social group/underweight_fwd_vs_group3.png}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/maternal nutrition by social group/underweight_fwd_vs_group4.png}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/maternal nutrition by social group/underweight_fwd_vs_group5.png}
\end{figure}

\newpage

\section{Prepregnancy BMI by parity and social group}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/maternal nutrition by social group/bmi_fwd_vs_group2.png}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/maternal nutrition by social group/bmi_fwd_vs_group3.png}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/maternal nutrition by social group/bmi_fwd_vs_group4.png}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{figures/maternal nutrition by social group/bmi_fwd_vs_group5.png}
\end{figure}
