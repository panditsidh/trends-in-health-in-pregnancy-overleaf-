...
\section{Prepregnancy underweight by }

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{do files/figures/underweight_fwd_vs_group2.png}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{do files/figures/underweight_fwd_vs_group3.png}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{do files/figures/underweight_fwd_vs_group4.png}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{do files/figures/underweight_fwd_vs_group5.png}
\end{figure}
